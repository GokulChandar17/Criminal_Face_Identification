...
class Construct extends JFrame implements ActionListener
{
	...
	Construct()
	{
		...
		try
		{
			...
			con=DriverManager.getConnection("jdbc:mysql://localhost:3306/criminalrecords","root","@#$5776267gc*");
			...
			while(rs.next())
			{
				...
				FileInputStream hairfin=new FileInputStream("");
				...
				FileInputStream fhfin=new FileInputStream(""+selcrimid+".gif");
				...
				FileInputStream eyesfin=new FileInputStream(""+selcrimid+".gif");
				...
				FileInputStream nosefin=new FileInputStream(""+selcrimid+".gif");
				...
				FileInputStream lipsfin=new FileInputStream(""+selcrimid+".gif");
				...
				FileInputStream chinfin=new FileInputStream(""+selcrimid+".gif");
...
public void writePhoto(int a[],int crid)
	...
	try
	{
		FileOutputStream suspectfout=new FileOutputStream(""+crid+".gif");
		DataOutputStream suspectdout=new DataOutputStream(suspectfout);
		FileInputStream hairfin=new FileInputStream(""+cids[0]+".gif");
		DataInputStream hairdin=new DataInputStream(hairfin);
		while(hairfin.available()>0)
		{
		...
		hairfin.close();
		hairdin.close();
		FileInputStream fhfin=new FileInputStream(""+cids[1]+".gif");
		DataInputStream fhdin=new DataInputStream(fhfin);
		while(fhfin.available()>0)
		{
		...
		fhfin.close();
		fhdin.close();
		FileInputStream eyesfin=new FileInputStream(""+cids[2]+".gif");
		DataInputStream eyesdin=new DataInputStream(eyesfin);
		while(eyesfin.available()>0)
		{
		...
		eyesfin.close();
		eyesdin.close();
		FileInputStream nosefin=new FileInputStream(""+cids[3]+".gif");
		DataInputStream nosedin=new DataInputStream(nosefin);
		while(nosefin.available()>0)
		{
		...
		nosefin.close();
		nosedin.close();
		FileInputStream lipsfin=new FileInputStream(""+cids[4]+".gif");
		DataInputStream lipsdin=new DataInputStream(lipsfin);
		while(lipsfin.available()>0)
		{
		...
		lipsfin.close();
		lipsdin.close();
		FileInputStream chinfin=new FileInputStream(""+cids[5]+".gif");
		DataInputStream chindin=new DataInputStream(chinfin);
		while(chinfin.available()>0)
		{
