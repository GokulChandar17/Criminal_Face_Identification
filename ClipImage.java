...
public void actionPerformed(ActionEvent evt)
{
	...
	if(evt.getSource()==btnHair)
	{
		...
		try
		{
			FileOutputStream fout=new FileOutputStream(""+selcrimid+".gif");
	...
	{
		lblHair.setIcon(new ImageIcon(""));
	}
	if(evt.getSource()==clearForeHead)
	{
		lblForeHead.setIcon(new ImageIcon(""));
	}
	if(evt.getSource()==clearEyes)
	{
		lblEyes.setIcon(new ImageIcon(""));
	}
	if(evt.getSource()==clearNose)
	{
		lblNose.setIcon(new ImageIcon(""));
	}
	if(evt.getSource()==clearLips)
	{
		lblLips.setIcon(new ImageIcon(""));
	}
	if(evt.getSource()==clearChin)
	{
		lblChin.setIcon(new ImageIcon(""));
	}
